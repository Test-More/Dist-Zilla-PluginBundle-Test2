...
https://metacpan.org/release/Dist-Zilla-PluginBundle-Test2

If you use cpanminus, you can do it without downloading the tarball first:

    $ cpanm --reinstall --installdeps --with-recommends Dist::Zilla::PluginBundle::Test2
...
You can also do this via cpanm directly:
    ...
    $ cpanm --reinstall --installdeps --with-develop --with-recommends Dist::Zilla::PluginBundle::Test2
...
template file originating in Dist-Zilla-PluginBundle-Test2-0.01.
